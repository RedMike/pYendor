#Block generating module.
#
#When run, takes all the block files in data/map/raw_blocks and turns them into proper block files.
#These new block files reside in data/map/blocks.
